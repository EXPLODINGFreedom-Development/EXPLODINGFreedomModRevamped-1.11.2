...
public class Command_tag extends TFM_Command
{
    ...
    {
        "admin", "co owner", "owner", "moderator", "developer", "console", "mod", "sa", "sta", "telnet multicraft admin", "tma", "executive", "system admin", "exec", "sys", "telnet admin", "dev", "builder", "architect"    });
