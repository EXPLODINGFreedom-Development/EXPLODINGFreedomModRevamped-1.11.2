...
public class Command_gadmin extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        {
            playerMsg("§7[ §aReal Name §7] §e: §7[ §6Display Name §7] - §cHash:");
            while (it.hasNext())
            {
                final Player player = it.next();
                sender.sendMessage(ChatColor.GRAY + String.format("§7[ §a%s §7] §e: §7[ §r%s §7] - §c"+"%s",
                        player.getName(),
        ...
        switch (mode)
        {
            case KICK:
            {
                ...
                target.kickPlayer("Kicked by an Administrator\n§6Kicked by:§c " + sender.getName());
            ...
            case NAMEBAN:
            {
                ...
                target.kickPlayer("§cUsername banned by Administrator.\n§6Banned by:§c " + sender.getName());
            ...
            case IPBAN:
            {
                ...
                target.kickPlayer("§cIP address banned by Administrator.\n§6Banned by:§c " + sender.getName());
            ...
            case BAN:
            {
                ...
                target.kickPlayer("§cIP and username banned by Administrator.\n§6Banned by:§c " + sender.getName());
            ...
            case FR:
            {
                ...
                playerMsg(target.getName() + " has been " + (playerdata.isFrozen() ? "§cfrozen" : "§aunfrozen") + ".");
                target.sendMessage(ChatColor.AQUA + "You have been " + (playerdata.isFrozen() ? "§cfrozen" : "§aunfrozen") + ".");
