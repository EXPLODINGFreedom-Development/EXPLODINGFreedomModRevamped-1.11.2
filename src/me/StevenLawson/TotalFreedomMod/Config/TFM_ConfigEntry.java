...
public enum TFM_ConfigEntry
{
    ...
    TABLIST_HEADER(String.class, "tablist_header"),
    TABLIST_FOOTER(String.class, "tablist_footer"),
    ...
    ENABLE_HISTORYWORLD(Boolean.class, "historyworld_enabled"),
    //
    ...
    // Vote Links
    VOTELINKS_VOTELINK1(String.class, "votelinks.votelink1"),
    VOTELINKS_VOTELINK2(String.class, "votelinks.votelink2"),
    VOTELINKS_VOTELINK3(String.class, "votelinks.votelink3"),
    VOTELINKS_VOTELINK4(String.class, "votelinks.votelink4"),
    VOTELINKS_VOTELINK5(String.class, "votelinks.votelink5"),
    VOTELINKS_VOTELINK6(String.class, "votelinks.votelink6"),
    VOTELINKS_VOTELINK7(String.class, "votelinks.votelink7"),
    VOTELINKS_VOTELINK8(String.class, "votelinks.votelink8"),
    // Rules
    RULES_RULE1(String.class, "rules.rule1"),
    RULES_RULE2(String.class, "rules.rule2"),
    RULES_RULE3(String.class, "rules.rule3"),
    RULES_RULE4(String.class, "rules.rule4"),
    RULES_RULE5(String.class, "rules.rule5"),
    RULES_RULE6(String.class, "rules.rule6"),
    RULES_RULE7(String.class, "rules.rule7"),
    RULES_RULE8(String.class, "rules.rule8"),
    RULES_RULE9(String.class, "rules.rule9"),
    RULES_RULE10(String.class, "rules.rule10"),
    RULES_RULE11(String.class, "rules.rule11"),
    RULES_RULE12(String.class, "rules.rule12"),
    RULES_RULE13(String.class, "rules.rule13"),
    RULES_RULE14(String.class, "rules.rule14"),
    RULES_RULE15(String.class, "rules.rule15"),
    RULES_RULE16(String.class, "rules.rule16"),
    
    
    // Chat Color Codes
    CHATCOLOR_STRING(String.class, "global_chatcolor"),
    CHATCOLOR_CODES(List.class, "chatcolor_codes"),
    // Economy Interface - OnFirstJoin balance
    FIRSTJOINAMOUNT(Integer.class, "firstjoin_amount"),
    //
    MAXHOMES(Integer.class, "max_homes"),
    //
    COMMANDBLOCK_COMMANDS(List.class, "disabled_commandblock_commands"),
