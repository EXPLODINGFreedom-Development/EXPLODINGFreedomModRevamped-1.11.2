...
import com.efdevelopment.EXPLODINGFreedomModRevamped.API.EFMR_BackEvents;
...
import com.efdevelopment.EXPLODINGFreedomModRevamped.misc.EFMR_DeathListener;
import com.efdevelopment.EXPLODINGFreedomModRevamped.misc.EFMR_JoinListener;
...
import me.StevenLawson.TotalFreedomMod.Listener.TFM_ChatListener;
import me.StevenLawson.TotalFreedomMod.Listener.TFM_ColoredChatListener;
import me.StevenLawson.TotalFreedomMod.Listener.TFM_EntityListener;
import me.StevenLawson.TotalFreedomMod.Listener.TFM_PlayerListener;
import me.StevenLawson.TotalFreedomMod.Listener.TFM_PlayerTabListener;
        ...
        extends JavaPlugin
{
    ...
    public static final String WARP_FILENAME = "warps.yml";
...
// public static final String RULES_FILENAME = "rules.yml";
    ...
    public void onEnable()
    {
        ...
        timer.start();
        if (!"v1_11_R1".equals(TFM_Util.getNmsVersion()))
        {
            TFM_Log.warning(
                    pluginName + " is compiled for " + "v1_11_R1" + " but the server is running " + "version " + TFM_Util.getNmsVersion() + "!");
        ...
        TFM_Util.createBackups("Spawn.yml");
        TFM_Util.createBackups("warps.yml");
        TFM_Util.createBackups("Data.yml");
        this.lists = new EFMR_Lists(this);
        this.lists.startup();
        ...
        pm.registerEvents(new TFM_ColoredChatListener(), plugin);
        pm.registerEvents(new TFM_ChatListener(), plugin);
        pm.registerEvents(new EFMR_JoinListener(), plugin);
        pm.registerEvents(new EFMR_DeathListener(), plugin);
        Bukkit.getPluginManager().registerEvents(new EFMR_BackEvents(this), this);
        pm.registerEvents(new TFM_PlayerTabListener(), plugin);
        ...
        try
        {
            TFM_SeniorWorld.getInstance().getWorld();
        }
        catch (Exception ex)
        {
    ...
    public void handleException(Exception ex)
    {
        ...
        System.out.println("An exception has occurred in the EXPLODINGFreedomMod, it is very likely this was an SQLite error, please check the logs for more details!");
    }
}
